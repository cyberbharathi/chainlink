...
// EthInterface is an autogenerated mock type for the EthInterface type
type EthInterface struct {
	mock.Mock
}

// AddKey provides a mock function with given fields: key
func (_m *EthInterface) AddKey(key *ethkey.Key) error {
	ret := _m.Called(key)
...
func (_m *EthInterface) AllKeys() ([]ethkey.Key, error) {
	ret := _m.Called()
...
func (_m *EthInterface) CreateNewKey() (ethkey.Key, error) {
	ret := _m.Called()
...
func (_m *EthInterface) EnsureFundingKey() (ethkey.Key, bool, error) {
	ret := _m.Called()
...
func (_m *EthInterface) ExportKey(address common.Address, newPassword string) ([]byte, error) {
...
func (_m *EthInterface) FundingKeys() ([]ethkey.Key, error) {
	ret := _m.Called()
...
func (_m *EthInterface) GetRoundRobinAddress(addresses ...common.Address) (common.Address, error) {
...
func (_m *EthInterface) HasDBSendingKeys() (bool, error) {
	ret := _m.Called()
...
func (_m *EthInterface) HasSendingKeyWithAddress(address common.Address) (bool, error) {
...
func (_m *EthInterface) ImportKey(keyJSON []byte, oldPassword string) (ethkey.Key, error) {
...
func (_m *EthInterface) ImportKeyFileToDB(keyPath string) (ethkey.Key, error) {
...
func (_m *EthInterface) KeyByAddress(address common.Address) (ethkey.Key, error) {
	ret := _m.Called(address)
...
func (_m *EthInterface) RemoveKey(address common.Address, hardDelete bool) (ethkey.Key, error) {
...
func (_m *EthInterface) SendingKeys() ([]ethkey.Key, error) {
	ret := _m.Called()
...
func (_m *EthInterface) SignTx(fromAddress common.Address, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
...
func (_m *EthInterface) SubscribeToKeyChanges() (chan struct{}, func()) {
	ret := _m.Called()
...
func (_m *EthInterface) Unlock(password string) error {
