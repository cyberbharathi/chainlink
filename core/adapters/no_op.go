...
func (noa *NoOp) Perform(input models.RunInput, _ *store.Store, _ *keystore.KeyStore) models.RunOutput {
...
func (noa *NoOpPendOutgoing) Perform(_ models.RunInput, _ *store.Store, _ *keystore.KeyStore) models.RunOutput {
